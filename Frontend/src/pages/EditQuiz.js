...
function EditQuiz(props) {
	...
	const submitCSV = async (questions) => {
		...
		let url = "https://be-quizzie.herokuapp.com/question/csv";
	...
	const handleRestart = async () => {
		...
		let url = `https://be-quizzie.herokuapp.com/quiz/restart`;
	...
	const handleQuizClose = async () => {
		...
		let url = `https://be-quizzie.herokuapp.com/quiz/close`;
	...
	const handleDeleteQuestion = async () => {
		...
		let url = `https://be-quizzie.herokuapp.com/question/${updateId}`;
	...
	const handleDelete = async () => {
		...
		let url = `https://be-quizzie.herokuapp.com/quiz/delete`;
	...
	const handleQuestionUpdate = async () => {
		...
		let url = `https://be-quizzie.herokuapp.com/question/update/${updateId}`;
	...
	const handleQuestionSubmit = async () => {
		...
		let url = `https://be-quizzie.herokuapp.com/question/add`;
	...
	const isOwnerOfQuiz = async () => {
		...
		let url = `https://be-quizzie.herokuapp.com/quiz/checkAdmin/${quizId}`;
	...
	const getQuizDetails = async () => {
		...
		let url = `https://be-quizzie.herokuapp.com/quiz/${quizId}`;
		...
		url = `https://be-quizzie.herokuapp.com/question/all/${quizId}`;
		...
		url = `https://be-quizzie.herokuapp.com/admin/allStudentsQuizResult/${quizId}`;
