...
function RegisterPage(props) {
	...
	const handleSubmit = async (event) => {
		...
		if (!errors && emailError.length === 0 && passwordError.length === 0) {
			...
			let url = `https://be-quizzie.herokuapp.com/${sType}/signup`;
			...
			try {
				...
				console.log('request axios selesai')
					...
					<a
						href={
							type === "user"
								...
								? "https://be-quizzie.herokuapp.com/auth/google"
								: "https://be-quizzie.herokuapp.com/auth/admin/google"
						}
