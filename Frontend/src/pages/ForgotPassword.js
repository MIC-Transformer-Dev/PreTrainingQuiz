	...
	const handleReset = async (event) => {
		...
		if (!errors && emailError.length === 0) {
			...
			if (userType === "organizer") {
				...
				url = `https://be-quizzie.herokuapp.com/admin/forgot`;
			} else if (userType === "user") {
				// url = `https://quizzie-api.herokuapp.com/user/forgot`;
				url = `https://be-quizzie.herokuapp.com/user/forgot`;
			}
	...
	const handleSubmit = async (event) => {
		...
		if (!errors) {
			...
			if (userType === "organizer") {
				...
				url = `https://be-quizzie.herokuapp.com/admin/resetpass`;
			} else if (userType === "user") {
				// url = `https://quizzie-api.herokuapp.com/user/resetpass`;
				url = `https://be-quizzie.herokuapp.com/user/resetpass`;
			}
