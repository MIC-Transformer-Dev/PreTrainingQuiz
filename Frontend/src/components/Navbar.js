	...
	return (
		<div className="root">
			...
			<AppBar position="static" className="navbar" elevation={4}>
				<Toolbar>
					<Link to="/" className="nav-link"><img src="../MIC Logo.png" className="nav-logo"/></Link>
					<Typography varirant="h6" className="nav-head">The Quizzie by MIC Transformer</Typography>
			...
			<Dialog open={loginModalOpen} onClose={onCloseHandle} aria-labelledby="form-dialog-title"
					...
					<div className="modal-info">
						<Typography variant="h5" className="type-head">Are you a participant or an organizer?</Typography>
						<div className="modal-btns">
							<Link to="/login/user" className="link">
								<Button variant="outlined" color="primary" 
									className="modal-select-btn modal-student" 
									onClick={() => setLoginModalOpen(false)}>Participant</Button>
							</Link>
