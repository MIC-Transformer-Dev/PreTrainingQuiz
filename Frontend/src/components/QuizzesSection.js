...
function QuizzesSection(props) {
	...
	const getQuizInfo = async (id) => {
		...
		let url = `https://be-quizzie.herokuapp.com/quiz/${id}`;
	...
	const handleJoinSubmit = async () => {
		...
		let url = "https://be-quizzie.herokuapp.com/quiz/enrollPrivate";
		let token = localStorage.getItem("authToken");
	...
	const handleEnroll = async () => {
		...
		let url = "https://be-quizzie.herokuapp.com/quiz/enroll";
	...
	const handleUnenroll = async () => {
		...
		let url = "https://be-quizzie.herokuapp.com/quiz/unenroll";
	...
	const handleQuizStart = async () => {
		...
		let url = `https://be-quizzie.herokuapp.com/quiz/start`;
	...
	const getQuizzes = async () => {
		...
		let url = "https://be-quizzie.herokuapp.com/quiz/all";
